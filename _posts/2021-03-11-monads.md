...
Monads can be seen as applicatives with the ability to dictate control using the effects.
...
Looking back, a monad is just a functor that can be applied repeatedly to an object, just like multiplication in a monoid.
